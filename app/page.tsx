...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] dark:bg-gray-900 transition-colors">
      ...
      {/* Footer */}
      <footer className="bg-[#1a1a1a] dark:bg-black text-gray-300 pt-12 pb-6 px-4 sm:px-6">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-3">
                  {/* Facebook */}
                  <a href="https://www.facebook.com/Century21VascoGroup" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-c21-gold flex items-center justify-center transition-colors">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/c21vasco?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-c21-gold flex items-center justify-center transition-colors">
                  ...
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/company/century-21-vasco-group" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-c21-gold flex items-center justify-center transition-colors">
                  ...
                  {/* YouTube */}
                  <a href="https://www.youtube.com/@century21vascogroup" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-c21-gold flex items-center justify-center transition-colors">
