            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-3">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/century21vascogroup" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-c21-gold flex items-center justify-center transition-colors">
